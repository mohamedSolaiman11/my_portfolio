...
- **🌓 Advanced Theme System:** Seamlessly toggle between Dark and Light modes using CSS variables.
...
- **Dynamic Theme Toggling:** A clean, modern switch in the navbar that persists your preference (Dark/Light) using `localStorage`.
- **Multilingual Support:** Fully switchable UI text between English and Arabic without reloading the page.
- **Responsive Navigation:**
    - **Desktop:** Elegant controls integrated into the navbar.
    - **Mobile:** Controls are neatly tucked into the side drawer to maintain a clean top-bar.
- **Dynamic Projects Section:** Projects are fetched from **Firebase Firestore** and support dual-language content.
...
- **Frontend:** HTML5, CSS3 (Custom Variables & Logical Properties), JavaScript (Vanilla ES6+).
...
Instead of hardcoding colors, the site uses a centralized system:


Simply open `index.html` in your favorite browser.
3. **Firebase Configuration:**
   Ensure your Firebase config is correctly set up in the script tags to fetch your live projects.
